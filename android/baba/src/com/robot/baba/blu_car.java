...
{ 
    ...
    private BluetoothAdapter mBluetoothAdapter = null;
     ...
     { 
 		...
 		// On regarde si un module bluetooth existe sur le téléphone
         ...
         // Si le module bluetooth n'est pas activé, on propose l'activation.
         ...
         connect_button.setOnClickListener(new View.OnClickListener() 
         {
 			...
 			{
				if (connectStat) 
				{									// Si on est connecté, On se deconnect.
